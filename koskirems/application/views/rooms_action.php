<?php $this->load->view('header') ?>;
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="row">
                <div class="col-lg-12 col-md-12">
             <?php if(isset($room_no)) { ?>
    <h2>Edit Room Records in <?php echo get_buildingname($hse)?></h2> 
   <form method="post" action="<?php echo site_url()?>/buildings/edit_room" data-abide>
        <label>Room No</label>&nbsp &nbsp &nbsp  &nbsp 
        <input type="text" name="room_no" value="<?php echo $room_no ?>" required=""/>
        <br/>  <br/> 
         <label>Rent Amount</label> &nbsp &nbsp 
        <input type="number" name="amt" value="<?php echo $amt ?>" required=""/>
       <br/>  <br/>
 
        <label>Room Type</label>&nbsp &nbsp &nbsp  
            ...
            <tbody>
                <?php foreach(get_data('tbl_rooms', 'WHERE room_buildingid = '.$hse) as $value) { ?>
                    <tr>
                      ...
                      <td><a href="<?php echo base_url()?>index.php/buildings/delete/<?php echo $value['room_id']?>"<?php echo $value['room_id'];?> onclick="return confirm('Are you sure you want to delete this record?');">Delete</a></td>
                      <td><a href="<?php echo site_url()?>/buildings/update_room/<?php echo $value['room_id']?>/<?php echo $hse?>">Edit</a></td>
                    </tr>
